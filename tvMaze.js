...
function displayEpisode(tvshowJSON){
  ...
  document.getElementById("lbImage").src = tvshowJSON.image.medium;
  document.getElementById("lbName").innerHTML = tvshowJSON.name;
  document.getElementById("lbSummary").innerHTML = tvshowJSON.summary
}
